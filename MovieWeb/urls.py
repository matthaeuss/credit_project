...
from MovieWeb.views import all_movies, new_movie, delete_movie, comment_movie, edit_profile, add_poster, show_posters, \
    edit_movie, add_movie_to_favorites, show_favorites, delete_movie_from_favorites, accept_movie_by_admin, accept_movie_object
...
urlpatterns = [
    ...
    path('delete_movie_from_favorites/<int:movie_favorite_id>/', delete_movie_from_favorites, name="delete_movie_from_favorites"),
